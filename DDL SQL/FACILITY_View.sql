...
SELECT        
	...
	dbo.FACILITY.Name AS FacilityName,
	dbo.FACILITY.NumberOfIncidents,
	dbo.FACILITY.TotalOverflow,
...
SELECT        
	dbo.EQUIPMENTRESTRICTION.Text AS EquipmentRestriction, 
	dbo.FACILITY.Name AS FacilityName, 
	dbo.FACILITY.FacilityID, 
	dbo.MAINTENANCERESTRICTION.Text AS MaintenanceRestriction,
